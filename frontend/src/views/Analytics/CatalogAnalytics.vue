...
const metricCards = computed(() => {
  ...
  const d = data.value;
  return [
    { title: 'Pengunjung',   value: d.total_visitors,   icon: '👁️', sub: '', subClass: '' },
    { title: 'Draft',        value: d.draft_orders,     icon: '📝', sub: '', subClass: '' },
    { title: 'Dikonfirmasi', value: d.confirmed_orders, icon: '✅', sub: '', subClass: '' },
    {
      title: 'Terbengkalai', value: d.abandoned_orders, icon: '⚠️',
      sub: d.abandoned_orders > 0 ? 'Perlu perhatian' : 'Bagus!',
      subClass: d.abandoned_orders > 0 ? 'text-red-400' : 'text-emerald-400',
    },
    {
      title: 'Konversi', value: `${d.conversion_rate}%`, icon: '📈',
